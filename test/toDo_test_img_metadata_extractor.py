...
if __name__ == '__main__':
    ...
    # Instancia del exportador de datos
    ...
    exporter.update_data_range(embeddings = embeddings,embeddingTranslator = embeddingTranslator,
                               researcher = researcher, file_range= [0,3], extra_context=extra_context, 
                               theme=theme, search_engine=search_engine)
